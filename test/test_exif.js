...
describe('parse exif',function(){
    it('should parse exif data from Nikon',function(done){
        ...
        extract(file,function(e,d){
            should.not.exist(e)
            should.exist(d)
            d.should.have.property('Make')
            d.should.have.property('Model')
            d.Make.should.match(/nikon/i)
            return done()
        })
    })
    ...
    it('should parse exif data from Fujifilm',function(done){
        ...
        extract(file,function(e,d){
            ...
            d.should.have.property('Make')
            d.should.have.property('Model')
            d.Make.should.match(/fujifilm/i)
            return done()
        })
    })
